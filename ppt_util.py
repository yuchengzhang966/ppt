...
# table of content : add_content_slide
...
def add_image_slide(prs, img_path, title_text=""):
    ...
    slide_layout_index (int): The index of the slide layout to use. Default is 3.
    title_text (str): The text for the slide's title. Default is an empty string.
    """
    # Load your image using Pillow to get its dimensions
...
def trim_space(image_path, output_path, white_threshold=100):
    ...
    :param output_path: Path to save the trimmed image.
    :param white_threshold: RGB threshold to consider a pixel as white.
    :param margin: Amount of white space to leave around the content.
    """
    # Open the image
